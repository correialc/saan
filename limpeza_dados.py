...
class LimpezaDados:
    ...
    def __init__(self, dados):
        ...
        dados.seg_limp = dados.seg_orig.copy()

    def remover_segmentos_nao_ade(self, dados):
        logging.info('Excluindo segmentos dos atos que não são ADE...')
        qtd_seg = dados.seg_limp['id_seg'].count()
        dados.seg_limp = dados.seg_limp[dados.seg_limp['tipo_ato']=='ADE'].copy()
        qtd_seg_ade = dados.seg_limp['id_seg'].count()
    ...
    def remover_segmentos_nao_representativos(self, dados):
        ...
        qtd_seg = dados.seg_limp['id_seg'].count()
        qtd_seg_rep = dados.seg_limp['tipo_seg'].isin(tipos_seg_representativos).sum()
        dados.seg_limp = dados.seg_limp[dados.seg_limp['tipo_seg'].isin(tipos_seg_representativos)]
    ...
    def remover_segmentos_nulos(self, dados):
        ...
        qtd_seg = dados.seg_limp['id_seg'].count()
        qtd_seg_na = dados.seg_limp['txt_seg'].isna().sum()
        dados.seg_limp = dados.seg_limp[dados.seg_limp['txt_seg'].notna()]
    ...
    def remover_tags_html(self, dados):
        ...
        dados.seg_limp['txt_seg'] = dados.seg_limp['txt_seg'].apply(remover_tags)
    ...
    def remover_escape_html(self, dados):
        ...
        dados.seg_limp['txt_seg'] = dados.seg_limp['txt_seg'].apply(remover_escape_chars)
        

    def reclassificar_nao_identificados(self, dados):
        logging.info('Reclassificando segmentos não identificados...')
        seg_ni = dados.seg_limp[dados.seg_limp['tipo_seg'] == 'Não Identificado']
        ...
        dados.seg_limp.loc[dados.seg_limp['id_seg'].isin(ids_reclassificaveis), 'tipo_seg'] = 'Artigo'
